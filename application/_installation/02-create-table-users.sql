CREATE TABLE IF NOT EXISTS `madebeta`.`users` (
...
INSERT INTO `madebeta`.`users` (`user_id`, `session_id`, `user_name`, `user_password_hash`, `user_email`, `user_active`, `user_deleted`, `user_account_type`,

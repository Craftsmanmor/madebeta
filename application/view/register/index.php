        ...
        <div class="grid-x grid-padding-x align-center">
            <div class="large-6 cell">
                <ul class="tabs" data-tabs id="example-tabs">
                    <li class="tabs-title is-active"><a href="<?php echo Config::get('URL'); ?>register/index" aria-selected="true">Employer</a></li>
                    <li class="tabs-title "><a href="<?php echo Config::get('URL'); ?>register/talent">Talent</a></li>
                </ul>
                <h5>Sign up for access to a curated pool of active, skilled talent today.</h5>
                <br>
                <form method="post" action="<?php echo Config::get('URL'); ?>register/register_action">
                    ...
                    <div class="grid-x grid-padding-x">
                        ...
                        <div class="large-6 cell">
                            <input type="submit" class="button expanded" value="Create an account" />
                        </div>
                    </div>
                </form>
            </div>
